...
SPACE_ID = "U3BhY2U6MTU3ODg6L2o1Rw==" # Change this line
API_KEY = "8bb925c083f54c64a9c" # Change this line
...
tracer_provider = register(
    space_id="U3BhY2U6MTU3ODg6L2o1Rw==",
    api_key="8bb925c083f54c64a9c",
    project_name="connect_america_support_assistant"
)
...
os.environ["LANGCHAIN_PROJECT"] = "connect-america-test"
...
def chat():
    try:
        ...
        # Select appropriate instructions based on type
        current_instructions = SYSTEM_INSTRUCTIONS_ADVICE if instruction_type == 'advice' else SYSTEM_INSTRUCTIONS
        ...
        try:
            ...
            3. Related to:
                ...
                - Customer support protocols and account management like Escalation procedures, Customer retention strategies, etc.
            ...
            7. Related to the company
                - Payment processing and collections
                - Technical support and device activation
                - Financial Operations
                - Employee Guidelines like Call handling procedures, Break time management, etc.
            ...
            # When logging to Arize
            arize_client = Client(SPACE_ID, API_KEY)
            prediction_id = str(uuid.uuid4())
            arize_client.log(
                model_id="connect_america_support_assistant",  # More descriptive model name
                ...
                prompt_template=current_instructions,
                tags={
                    "instruction_type": instruction_type,
                    "has_chat_history": len(chat_history) > 0,
                    "space_id": SPACE_ID  # Adding space_id as a tag for reference
                }
            )
